...
namespace SharePointAddIn3Web.DataSet1TableAdapters {
    ...
    public partial class BATCH_SHEETS_NewTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [BATCH_SHEETS_New] WHERE (([Row] = @Original_Row))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [BATCH_SHEETS_New] ([DATE], [MIXER], [GRADE], [BATCH_NUMBER], [INGRED" +
                "IENT1], [INGREDIENT2], [INGREDIENT3], [INGREDIENT4], [INGREDIENT5], [INGREDIENT6" +
                "], [INGREDIENT7], [INGREDIENT8], [INGREDIENT9], [INGREDIENT10], [INGREDIENT11], " +
                "[INGREDIENT12], [LOT_NO1], [LOT_NO2], [LOT_NO3], [LOT_NO4], [LOT_NO5], [LOT_NO6]" +
                ", [LOT_NO7], [LOT_NO8], [LOT_NO9], [LOT_NO10], [LOT_NO11], [LOT_NO12], [AMOUNT1]" +
                ", [AMOUNT2], [AMOUNT3], [AMOUNT4], [AMOUNT5], [AMOUNT6], [AMOUNT7], [AMOUNT8], [" +
                "AMOUNT9], [AMOUNT10], [AMOUNT11], [AMOUNT12], [LOADED_BY1], [LOADED_BY2], [LOADE" +
                "D_BY3], [LOADED_BY4], [LOADED_BY5], [LOADED_BY6], [LOADED_BY7], [LOADED_BY8], [L" +
                "OADED_BY9], [LOADED_BY10], [LOADED_BY11], [LOADED_BY12], [MIXING_INSTRUCTIONS], " +
                "[TYPE_OF_DRUM], [WEIGHT_PER_DRUM], [NUMBER_OF_DRUMS], [WEIGHT_PRODUCED], [REVISI" +
                "ON_DATE], [FORM_VERSION], [MIXER_BATCH_SHEET], [INST2], [SAMPLE_AND_LABEL], [ING" +
                "RED], [POT_FORMULA], [BLADE_SPEED], [SPEED], [PRESS_DATA], [EXPIRATION_DATE], [S" +
                "TORAGE], [THEOR_WT], [OPER], [OPER_Copy], [Adage_Item_Code], [LastUpdate], [Whic" +
                "hUser], [NameofMachine]) VALUES (@DATE, @MIXER, @GRADE, @BATCH_NUMBER, @INGREDIE" +
                "NT1, @INGREDIENT2, @INGREDIENT3, @INGREDIENT4, @INGREDIENT5, @INGREDIENT6, @INGR" +
                "EDIENT7, @INGREDIENT8, @INGREDIENT9, @INGREDIENT10, @INGREDIENT11, @INGREDIENT12" +
                ", @LOT_NO1, @LOT_NO2, @LOT_NO3, @LOT_NO4, @LOT_NO5, @LOT_NO6, @LOT_NO7, @LOT_NO8" +
                ", @LOT_NO9, @LOT_NO10, @LOT_NO11, @LOT_NO12, @AMOUNT1, @AMOUNT2, @AMOUNT3, @AMOU" +
                "NT4, @AMOUNT5, @AMOUNT6, @AMOUNT7, @AMOUNT8, @AMOUNT9, @AMOUNT10, @AMOUNT11, @AM" +
                "OUNT12, @LOADED_BY1, @LOADED_BY2, @LOADED_BY3, @LOADED_BY4, @LOADED_BY5, @LOADED" +
                "_BY6, @LOADED_BY7, @LOADED_BY8, @LOADED_BY9, @LOADED_BY10, @LOADED_BY11, @LOADED" +
                "_BY12, @MIXING_INSTRUCTIONS, @TYPE_OF_DRUM, @WEIGHT_PER_DRUM, @NUMBER_OF_DRUMS, " +
                "@WEIGHT_PRODUCED, @REVISION_DATE, @FORM_VERSION, @MIXER_BATCH_SHEET, @INST2, @SA" +
                "MPLE_AND_LABEL, @INGRED, @POT_FORMULA, @BLADE_SPEED, @SPEED, @PRESS_DATA, @EXPIR" +
                "ATION_DATE, @STORAGE, @THEOR_WT, @OPER, @OPER_Copy, @Adage_Item_Code, @LastUpdat" +
                "e, @WhichUser, @NameofMachine)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [BATCH_SHEETS_New] SET [DATE] = @DATE, [MIXER] = @MIXER, [GRADE] = @GRADE," +
                " [BATCH_NUMBER] = @BATCH_NUMBER, [INGREDIENT1] = @INGREDIENT1, [INGREDIENT2] = @" +
                "INGREDIENT2, [INGREDIENT3] = @INGREDIENT3, [INGREDIENT4] = @INGREDIENT4, [INGRED" +
                "IENT5] = @INGREDIENT5, [INGREDIENT6] = @INGREDIENT6, [INGREDIENT7] = @INGREDIENT" +
                "7, [INGREDIENT8] = @INGREDIENT8, [INGREDIENT9] = @INGREDIENT9, [INGREDIENT10] = " +
                "@INGREDIENT10, [INGREDIENT11] = @INGREDIENT11, [INGREDIENT12] = @INGREDIENT12, [" +
                "LOT_NO1] = @LOT_NO1, [LOT_NO2] = @LOT_NO2, [LOT_NO3] = @LOT_NO3, [LOT_NO4] = @LO" +
                "T_NO4, [LOT_NO5] = @LOT_NO5, [LOT_NO6] = @LOT_NO6, [LOT_NO7] = @LOT_NO7, [LOT_NO" +
                "8] = @LOT_NO8, [LOT_NO9] = @LOT_NO9, [LOT_NO10] = @LOT_NO10, [LOT_NO11] = @LOT_N" +
                "O11, [LOT_NO12] = @LOT_NO12, [AMOUNT1] = @AMOUNT1, [AMOUNT2] = @AMOUNT2, [AMOUNT" +
                "3] = @AMOUNT3, [AMOUNT4] = @AMOUNT4, [AMOUNT5] = @AMOUNT5, [AMOUNT6] = @AMOUNT6," +
                " [AMOUNT7] = @AMOUNT7, [AMOUNT8] = @AMOUNT8, [AMOUNT9] = @AMOUNT9, [AMOUNT10] = " +
                "@AMOUNT10, [AMOUNT11] = @AMOUNT11, [AMOUNT12] = @AMOUNT12, [LOADED_BY1] = @LOADE" +
                "D_BY1, [LOADED_BY2] = @LOADED_BY2, [LOADED_BY3] = @LOADED_BY3, [LOADED_BY4] = @L" +
                "OADED_BY4, [LOADED_BY5] = @LOADED_BY5, [LOADED_BY6] = @LOADED_BY6, [LOADED_BY7] " +
                "= @LOADED_BY7, [LOADED_BY8] = @LOADED_BY8, [LOADED_BY9] = @LOADED_BY9, [LOADED_B" +
                "Y10] = @LOADED_BY10, [LOADED_BY11] = @LOADED_BY11, [LOADED_BY12] = @LOADED_BY12," +
                " [MIXING_INSTRUCTIONS] = @MIXING_INSTRUCTIONS, [TYPE_OF_DRUM] = @TYPE_OF_DRUM, [" +
                "WEIGHT_PER_DRUM] = @WEIGHT_PER_DRUM, [NUMBER_OF_DRUMS] = @NUMBER_OF_DRUMS, [WEIG" +
                "HT_PRODUCED] = @WEIGHT_PRODUCED, [REVISION_DATE] = @REVISION_DATE, [FORM_VERSION" +
                "] = @FORM_VERSION, [MIXER_BATCH_SHEET] = @MIXER_BATCH_SHEET, [INST2] = @INST2, [" +
                "SAMPLE_AND_LABEL] = @SAMPLE_AND_LABEL, [INGRED] = @INGRED, [POT_FORMULA] = @POT_" +
                "FORMULA, [BLADE_SPEED] = @BLADE_SPEED, [SPEED] = @SPEED, [PRESS_DATA] = @PRESS_D" +
                "ATA, [EXPIRATION_DATE] = @EXPIRATION_DATE, [STORAGE] = @STORAGE, [THEOR_WT] = @T" +
                "HEOR_WT, [OPER] = @OPER, [OPER_Copy] = @OPER_Copy, [Adage_Item_Code] = @Adage_It" +
                "em_Code, [LastUpdate] = @LastUpdate, [WhichUser] = @WhichUser, [NameofMachine] =" +
                " @NameofMachine WHERE (([Row] = @Original_Row))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = System.Configuration.ConfigurationManager.ConnectionStrings["adageConnectionString"].ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = @"SELECT        Row, DATE, MIXER, GRADE, BATCH_NUMBER, INGREDIENT1, INGREDIENT2, INGREDIENT3, INGREDIENT4, INGREDIENT5, INGREDIENT6, INGREDIENT7, INGREDIENT8, INGREDIENT9, INGREDIENT10, 
                         INGREDIENT11, INGREDIENT12, LOT_NO1, LOT_NO2, LOT_NO3, LOT_NO4, LOT_NO5, LOT_NO6, LOT_NO7, LOT_NO8, LOT_NO9, LOT_NO10, LOT_NO11, LOT_NO12, AMOUNT1, AMOUNT2, AMOUNT3, AMOUNT4,
                          AMOUNT5, AMOUNT6, AMOUNT7, AMOUNT8, AMOUNT9, AMOUNT10, AMOUNT11, AMOUNT12, LOADED_BY1, LOADED_BY2, LOADED_BY3, LOADED_BY4, LOADED_BY5, LOADED_BY6, LOADED_BY7, 
                         LOADED_BY8, LOADED_BY9, LOADED_BY10, LOADED_BY11, LOADED_BY12, MIXING_INSTRUCTIONS, TYPE_OF_DRUM, WEIGHT_PER_DRUM, NUMBER_OF_DRUMS, WEIGHT_PRODUCED, REVISION_DATE, 
                         FORM_VERSION, MIXER_BATCH_SHEET, INST2, SAMPLE_AND_LABEL, INGRED, POT_FORMULA, BLADE_SPEED, SPEED, PRESS_DATA, EXPIRATION_DATE, STORAGE, THEOR_WT, OPER, OPER_Copy, 
                         Adage_Item_Code, LastUpdate, WhichUser, NameofMachine
FROM            BATCH_SHEETS_New
WHERE Row = @RowId";
        ...
        public virtual int Fill(DataSet1.BATCH_SHEETS_NewDataTable dataTable, int RowId) {
        ...
        public virtual DataSet1.BATCH_SHEETS_NewDataTable GetData(int RowId) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            this.Adapter.SelectCommand.Parameters[0].Value = ((int)(RowId));
            DataSet1.BATCH_SHEETS_NewDataTable dataTable = new DataSet1.BATCH_SHEETS_NewDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DataSet1.BATCH_SHEETS_NewDataTable dataTable) {
        ...
        public virtual int Update(
            ...
            this.Adapter.UpdateCommand.Parameters[76].Value = ((int)(Original_Row));
